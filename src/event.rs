...
impl ApplicationHandler<Event> for Processor {
    ...
    fn about_to_wait(&mut self, event_loop: &ActiveEventLoop) {
        ...
        // Drain non-blocking IPC messages.
        #[cfg(unix)]
        if let Some(listener) = &mut self.ipc_listener {
...
impl<'a, N: Notify + 'a, T: EventListener> input::ActionContext<T> for ActionContext<'a, N, T> {
    ...
    fn toggle_vi_mode(&mut self) {
        ...
        self.window()
            .set_ime_inhibitor(ImeInhibitor::VI, !was_in_vi_mode);
            ...
            WinitEvent::WindowEvent { event, .. } => {
                match event {
                    ...
                    WindowEvent::Focused(is_focused) => {
                        ...
                        self.ctx
                            .window()
                            .set_ime_inhibitor(ImeInhibitor::FOCUS, !is_focused);
                    }
