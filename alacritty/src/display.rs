...
impl Display {
    pub fn new(mut window: Window, config: &UiConfig) -> Result<Display, Error> {
        ...
        damage_tracker.frame().mark_fully_damaged();
        damage_tracker.next_frame().mark_fully_damaged();
    ...
    pub fn draw<T: EventListener>(
        ...
        let transparent = config.window_opacity() < 1.0;
        let requires_full_damage = transparent
